# -*- coding: utf-8 -*-
#
# pytest-testbook documentation build configuration file, created by
...
project = u'pytest-testbook'
copyright = u'2015, Ernesto D. Luzon Jr.'
author = u'Ernesto D. Luzon Jr.'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-testbook Documentation',
     [author], 1)
]
